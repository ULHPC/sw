...
#####################################################################################################
# RESIF 3.0 Building Apps Slurm launcher - Testing CPU Skylake Builds against prod 2019b software set
#####################################################################################################
#
#SBATCH -J RESIF-Test-2019b-CPU-Skylake
...
launcher=${TOP_DIR}/scripts/launcher-test-build-cpu-skylake.sh
